      ...
      <div className="relative flex flex-col md:flex-row gap-0 md:gap-0 items-stretch">
        {PROCESS_STEPS.map((step, index) => (
          <div key={step.number} className="flex md:flex-1 flex-col md:flex-row items-center">
            {/* Step card */}
            <div className="flex-1 w-full bg-white border border-[#e2e8f0] shadow-sm rounded-2xl p-6 flex flex-col gap-3 text-center">
              {/* Number badge */}
              <div className="w-10 h-10 rounded-full bg-[rgba(0,212,200,0.1)] border border-[rgba(0,212,200,0.25)] flex items-center justify-center mx-auto">
